...
* parameter[=].resource = DDCCVSQuestionnaireResponseSpanish
...
* type = #batch
* entry[+].fullUrl = "http://www.example.org/fhir/Parameters/DDCCVSTXSHEParametersSpanish"
* entry[=].resource = DDCCVSTXSHEParametersSpanish
