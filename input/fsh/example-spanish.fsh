...
* recommendation.vaccineCode.coding[ddccVaccine] = $ICD11#XM0CX4 "Vacuna COVID-19, vector viral de replicación"
...
* vaccineCode.coding[ddccVaccine] = $ICD11#XM0CX4 "Vacuna COVID-19, vector viral de replicación"
