...
* recommendation.vaccineCode.coding[ddccVaccine] = $ICD11#XM0CX4 "COVID-19 疫苗，复制病毒载体"
...
* vaccineCode.coding[ddccVaccine] = $ICD11#XM0CX4 "COVID-19 疫苗，复制病毒载体"
...
* protocolApplied[protocolAppliedAuthority].targetDisease = $ICD11#RA01 "新冠肺炎"
