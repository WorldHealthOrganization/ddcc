...
* recommendation.vaccineCode.coding[ddccVaccine] = $ICD11#XM0CX4 "لقاح COVID-19 ، تكرار الناقل الفيروسي"
...
* vaccineCode.coding[ddccVaccine] = $ICD11#XM0CX4 "لقاح COVID-19 ، تكرار الناقل الفيروسي"
...
* protocolApplied[protocolAppliedAuthority].targetDisease = $ICD11#RA01 "كوفيد -19"
