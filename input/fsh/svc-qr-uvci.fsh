...
* differential.element[+].id = "SVC-QR-UVCI"
* differential.element[=].path = "SVC-QR-UVCI"
* differential.element[=].definition = "QR code associated to an SVC UVCI"
* differential.element[=].min = 0
* differential.element[=].max = "*"


* differential.element[+].id = "SVC-QR-UVCI.version"
* differential.element[=].path = "SVC-QR-UVCI.version"
...
* differential.element[+].id = "SVC-QR-UVCI.name"
* differential.element[=].path = "SVC-QR-UVCI.name"
...
* differential.element[+].id = "SVC-QR-UVCI.birthDate"
* differential.element[=].path = "SVC-QR-UVCI.birthDate"
...
* differential.element[+].id = "SVC-QR-UVCI.patientid"
* differential.element[=].path = "SVC-QR-UVCI.patientid"
...
* differential.element[+].id = "SVC-QR-UVCI.paperid"
* differential.element[=].path = "SVC-QR-UVCI.paperid"
...
* differential.element[+].id = "SVC-QR-UVCI.digitalid"
* differential.element[=].path = "SVC-QR-UVCI.digitalid"
...
* differential.element[+].id = "SVC-QR-UVCI.pha"
* differential.element[=].path = "SVC-QR-UVCI.pha"
...
* differential.element[+].id = "SVC-QR-UVCI.signature"
* differential.element[=].path = "SVC-QR-UVCI.signature"
