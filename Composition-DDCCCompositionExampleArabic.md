...
**author**: [Organization مستشفى حكومي](Organization-DDCCOrganizationArabic.md)
...
| :--- | :--- | :--- |
| - | **Mode** | **Party** |
| * | Official | [Organization مستشفى حكومي](Organization-DDCCOrganizationArabic.md) |
...
```json
{
  ...
  "id" : "DDCCCompositionExampleArabic",
  "meta" : {
