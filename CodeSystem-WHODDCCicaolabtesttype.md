# ICAO lab test type codes used in this IG - WHO Digital Documentation of COVID-19 Certificates (DDCC) v1.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **ICAO lab test type codes used in this IG**

## CodeSystem: ICAO lab test type codes used in this IG (Experimental) 

| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/ddcc/CodeSystem/WHODDCCicaolabtesttype | *Version*:1.0.0 |
| Draft as of 2026-09-05 | *Computable Name*:WHODDCCicaolabtesttype |
...
```json
{
  ...
  "id" : "WHODDCCicaolabtesttype",
  "url" : "http://smart.who.int/ddcc/CodeSystem/WHODDCCicaolabtesttype",
  "version" : "1.0.0",
  "name" : "WHODDCCicaolabtesttype",
