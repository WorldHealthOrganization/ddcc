# Lab Test - Type - ICAO - WHO Digital Documentation of COVID-19 Certificates (DDCC) v1.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Lab Test - Type - ICAO**

## ValueSet: Lab Test - Type - ICAO (Experimental) 

| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/ddcc/ValueSet/LabTestTypeIcaoValueSet | *Version*:1.0.0 |
| Draft as of 2026-09-05 | *Computable Name*:LabTestTypeIcaoValueSet |
...
```json
{
  ...
  "id" : "LabTestTypeIcaoValueSet",
  "url" : "http://smart.who.int/ddcc/ValueSet/LabTestTypeIcaoValueSet",
  "version" : "1.0.0",
  "name" : "LabTestTypeIcaoValueSet",
  ...
  "compose" : {
    "include" : [{
      "system" : "http://smart.who.int/ddcc/CodeSystem/LabTestTypeIcaoValueSet",
      "concept" : [{
        "code" : "molecular(PCR)",
