# Lab Test - Result - Mapping DIVOC to ICD-11 - WHO Digital Documentation of COVID-19 Certificates (DDCC) v1.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Lab Test - Result - Mapping DIVOC to ICD-11**

## ConceptMap: Lab Test - Result - Mapping DIVOC to ICD-11 

| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/ddcc/ConceptMap/lab-test-qual-result-divoc-to-icd11 | *Version*:1.0.0 |
| Draft as of 2023-02-21 | *Computable Name*:LabTestQualResultDivocToIcd11ConceptMap |
| **Copyright/Legal**: TODO: provide copyright information | |

 
[Lab Test - Qualitative Result - DIVOC](ValueSet-lab-test-qual-result-divoc.md) mapped to ICD-11 
